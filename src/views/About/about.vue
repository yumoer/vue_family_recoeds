<template>
  <div>
    ...
    >
      <div
        ...
        style="
          width: 101%;
          height: 130%;
          background-image: url('src/assets/img/bg-img/bg-2.jpg');
        "
      ></div>
      <!-- breadcumb content -->
    ...
    <!-- ##### About Us Area Start ##### -->
    <section
      class="about-us-area ico-about-bg section-padding-100-0 clearfix"
      id="about"
    >
      <div class="container">
            ...
            <div class="who-we-contant">
              ...
              >
                <span class="gradient-text blue"
                  >We are the experts you exactly need</span
                >
              </div>
              ...
              <p class="fadeInUp" data-wow-delay="0.4s">
                ...
                repellat excepturi nobis eum culpa voluptates dolorem dolorum et
                Ducimus eum culpa voluptates dolorem dolorum et sit nisi,
                mollitia animi porro fuga sequi.
              </p>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="side-feature-list-item">
                      <i
                        class="fa fa-check-square-o check-mark-icon-font"
                        aria-hidden="true"
                      ></i>
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
              <div class="our-team ico-team">
                <div class="team_img">
                  <img
                    src="src/assets/img/team-img/member1.png"
            ...
            <div class="col-12 col-sm-6 col-lg-3">
              <div class="our-team ico-team">
                <div class="team_img">
                  <img
                    src="src/assets/img/team-img/member2.png"
                    class="mt-30 width-80"
                    alt="chef-1"
                  />
                  <ul class="social">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
              <div class="our-team ico-team">
                <div class="team_img">
                  <img
                    src="src/assets/img/team-img/member3.png"
                    class="mt-30 width-80"
                    alt="chef-1"
                  />
                  <ul class="social">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
              <div class="our-team ico-team">
                <div class="team_img">
                  <img
                    src="src/assets/img/team-img/member4.png"
                    class="mt-30 width-80"
                    alt="chef-1"
                  />
                  <ul class="social">
              ...
              <div class="team-member">
                <div class="team-img">
                  <img
                    ...
                    src="src/assets/img/partners/1.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                <div class="team-img">
                  <img
                    class="img-responsive center-block"
                    src="src/assets/img/partners/2.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                <div class="team-img">
                  <img
                    class="img-responsive center-block"
                    src="src/assets/img/partners/3.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                <div class="team-img">
                  <img
                    class="img-responsive center-block"
                    src="src/assets/img/partners/4.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                <div class="team-img">
                  <img
                    class="img-responsive center-block"
                    src="src/assets/img/partners/5.png"
                    alt=""
                  />
                </div>
              </div>
